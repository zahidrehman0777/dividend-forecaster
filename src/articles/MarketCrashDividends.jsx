...
export default function MarketCrashDividends({ t, navigate }) {
  ...
  return (
    <motion.div key="article:what-a-market-crash-does-to-dividends" {...pageT} style={{ maxWidth:800, margin:"0 auto", padding:"48px 24px 60px" }}>
      ...
      <p style={p}>First: <strong style={b}>dividend strategies aren't crash-proof as strategies.</strong> In the 2020 selloff, most dividend-focused index funds fell <em>harder</em> than the S&amp;P 500 itself — the sectors that pay dividends were the sectors the pandemic hit. Steadier income, not a steadier ride.</p>
