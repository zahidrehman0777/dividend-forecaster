...
export default function AristocratsKings({ t, navigate }) {
  ...
  return (
    <motion.div key="article:dividend-aristocrats-and-kings" {...pageT} style={{ maxWidth:800, margin:"0 auto", padding:"48px 24px 60px" }}>
      ...
      <p style={p}>The S&amp;P 500 Dividend Aristocrats index has three requirements: be a member of the S&amp;P 500, have increased the dividend every year for at least 25 consecutive years, and meet the index's size and liquidity rules. Not just <em>paid</em> a dividend for 25 years — <em>raised</em> it, every single year, without one skip.</p>
