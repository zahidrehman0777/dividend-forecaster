...
export default function DividendsVsSelling({ t, navigate }) {
  ...
  return (
    <motion.div key="article:living-off-dividends-vs-selling-shares" {...pageT} style={{ maxWidth:800, margin:"0 auto", padding:"48px 24px 60px" }}>
      ...
      <p style={p}>The selling approach's anchor is usually quoted as folklore, so here's what the research actually said. In 1994, William Bengen tested every rolling 30-year retirement in modern U.S. market history and asked what first-year withdrawal rate — <em>adjusted upward for inflation every year after</em> — survived even the worst starting point. The answer was <strong style={b}>4.15%</strong>, which the world rounded down to 4%. The Trinity Study (1998) reframed the same question as success rates: roughly 95% of historical 30-year retirements survived 4% inflation-adjusted withdrawals from a balanced stock-heavy portfolio.</p>
