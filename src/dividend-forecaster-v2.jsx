    ...
    <div style={{ minHeight:"100vh", background:t.bg, color:t.tx, fontFamily:FONT, transition:"background 0.3s, color 0.3s" }}>
      ...
      {page === "learn" ? (
        <motion.div key="learn" {...pageT} style={{ maxWidth:800, margin:"0 auto", padding:"48px 24px 60px" }}>
          ...
          <p style={{ fontSize:12, color:t.tx3, marginBottom:16 }}>Written by Zahid Rehman · Updated July 2026</p>
          ...
          {(() => {
            ...
            const sections = [
              ...
              { t:"Dividend Aristocrats", b:"Dividend Aristocrats are S&P 500 companies that have raised their dividend for 25+ consecutive years. As of 2026, a record 69 companies qualify.\n\nDividend Kings go even further — 50+ consecutive years. Coca-Cola, Johnson & Johnson, and Procter & Gamble are in both groups.\n\nA company that raised its dividend every year for 50 years — through recessions, financial crises, pandemics — has demonstrated extreme commitment to shareholders. You can invest in all Aristocrats at once through the NOBL ETF.", link:{ prefix:"More:", text:"Dividend Aristocrats and Kings, Explained", slug:"dividend-aristocrats-and-kings" } },
